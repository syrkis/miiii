...
# %% Configuration
cfg = mi.utils.Conf(project="miiii", p=37, epochs=1000, lamb=2, dropout=0.1, l2=0.1)
...
# %%
# edge = esch.EdgeConfigs(bottom=esch.EdgeConfig(label=[f"head {i}" for i in range(cfg.heads)]))
