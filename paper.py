...
f_hash = "2bca407ccf414c058e7bcc6e"  # hash of miiii task
...
# %%
data = (f_scope.neuron_freqs / f_scope.neuron_freqs.max(1, keepdims=True))[1000 :: 50000 // 226].T
esch.plot(data)
...
esch.plot(f_neurs.mean((0, 1))[None, :])
