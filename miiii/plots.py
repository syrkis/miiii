...
def plot_y(**kwargs) -> None:
    ...
    def anim() -> None:
        ...
        esch.save(e.dwg, f"figs/{cfg.p}.svg")
    ...
    def mult() -> None:
        ...
        for idx, task in enumerate(arr):
            ...
            esch.save(e.dwg, f"figs/{cfg.p}_mod_{ds.primes[idx].item()}.svg")
    ...
    #         esch.save(e.dwg, f"figs/{cfg.p}_batch_{idx}.svg")
...
def plot_x(**kwargs) -> None:
    ...
    esch.save(e.dwg, f"figs/{cfg.p}_x.svg")
...
def plot_params(**kwargs) -> None:  # cfg, ds, params: mi.types.Params):
    ...
    esch.save(e.dwg, f"figs/{cfg.p}_unbeds_x.svg")
...
def plot_metrics(**kwargs) -> None:
    ...
    def metrics() -> None:
        ...
        esch.save(e.dwg, f"figs/{cfg_to_str(cfg)}_train.svg")
    ...
    def period() -> None:
        ...
        esch.save(e.dwg, f"figs/{cfg_to_str(cfg)}_fft.svg")
    ...
    def all_periods() -> None:
        ...
        esch.save(e.dwg, f"figs/{cfg_to_str(cfg)}_all_neu.svg")
    ...
    def money_shot() -> None:
        ...
        esch.save(e.dwg, f"figs/money_shot_{cfg_to_str(cfg)}.svg")
